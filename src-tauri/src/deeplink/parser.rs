...
//!
//! Parses clawswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a clawswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// clawswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "clawswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'clawswitch', got '{scheme}'"
        )));
    }
