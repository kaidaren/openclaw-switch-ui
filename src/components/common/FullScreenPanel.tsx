...
interface FullScreenPanelProps {
  ...
  /** 启用左右双栏布局，children 需传入 [leftPanel, rightPanel] 两个元素 */
  splitLayout?: boolean;
  /** 双栏模式下左栏宽度，默认 320px */
        ...
        >
          ...
          {splitLayout ? (
            <div className="flex-1 flex overflow-hidden">
              {/* 左栏：预设列表 */}
              <div
                className="flex-shrink-0 border-r border-border-default overflow-y-auto scroll-overlay"
                style={{ width: splitLeftWidth ?? 320 }}
              >
              ...
              {/* 右栏：表单 */}
              <div className="flex-1 overflow-y-auto scroll-overlay min-w-0">
