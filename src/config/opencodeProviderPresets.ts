...
import { getBailianOpencodeDefaultModels } from "./bailianShared";

/** 百炼相关预设仅支持 OpenAI Compatible 与 Anthropic 接口格式 */
export const BAILIAN_ALLOWED_NPM_PACKAGES = [
...
export const opencodeProviderPresets: OpenCodeProviderPreset[] = [
  ...
  },
  {
    ...
    settingsConfig: {
      ...
      models: getBailianOpencodeDefaultModels(),
    },
    category: "aggregator",
    icon: "bailian",
    iconColor: "#624AFF",
    allowedNpmPackages: BAILIAN_ALLOWED_NPM_PACKAGES,
    templateValues: {
      baseURL: {
        label: "Base URL",
