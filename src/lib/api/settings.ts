...
export const settingsApi = {
  ...
  async openLocalPath(directory: string, app?: string): Promise<void> {
    await invoke("open_skill_dir", { directory, app });
  },
  ...
  async checkCliEnv(tool: string, minNodeMajor?: number): Promise<{
    has_node: boolean;
    ...
    return await invoke("check_cli_env", { tool, minNodeMajor });
  },
