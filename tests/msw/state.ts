...
let mcpConfigs: McpConfigState = {
  claude: {
    sample: {
      ...
      enabled: true,
      apps: { claude: true, codex: false, gemini: false, opencode: false, openclaw: false, qwen: false, cline: false },
      server: {
        type: "stdio",
  ...
  codex: {
    httpServer: {
      ...
      enabled: false,
      apps: { claude: false, codex: true, gemini: false, opencode: false, openclaw: false, qwen: false, cline: false },
      server: {
        type: "http",
