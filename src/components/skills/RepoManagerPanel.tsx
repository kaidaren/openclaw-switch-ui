...
export function RepoManagerPanel({
  ...
  return (
    ...
    >
      {/* 添加仓库表单 */}
      <div className="space-y-4 bg-bg-card border border-border-subtle shadow-sm rounded-xl p-6">
      ...
      <div className="space-y-4">
        ...
        {repos.length === 0 ? (
          <div className="text-center py-12 bg-bg-card border border-border-subtle shadow-sm rounded-xl">
          ...
          <div className="space-y-3">
            {repos.map((repo) => (
              <div
                ...
                className="flex items-center justify-between bg-bg-card border border-border-subtle shadow-sm rounded-xl px-4 py-3"
              >
                <div>
