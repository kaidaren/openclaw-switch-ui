  ...
  return (
    <div className="flex flex-col h-full overflow-hidden px-6">
      {isBusy ? (
        ...
        >
          <TabsList className="grid w-full grid-cols-5 mb-6 bg-bg-secondary rounded-xl">
          ...
          <div className="flex-1 min-h-0 flex flex-col">
                ...
                {settings ? (
                  ...
                  >
                    ...
                    >
                      <AccordionItem
                        value="directory"
                        className="rounded-xl bg-bg-card border border-border-subtle shadow-sm overflow-hidden"
                      >
                        <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-bg-secondary/50 data-[state=open]:bg-bg-secondary/50">
            ...
            {activeTab === "advanced" && settings && (
              <div
                className="flex-shrink-0 py-4 border-t border-border-subtle"
