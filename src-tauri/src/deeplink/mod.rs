//! Deep link import functionality for Claw Switch
//!
//! This module implements the clawswitch:// protocol for importing configurations
...
///
/// Represents a parsed clawswitch:// URL ready for processing.
