/**
 * 前端日志工具 - 与 openclaw-manager/src/lib/logger.ts 保持一致
...
const getCurrentLevel = (): LogLevel => {
  if (typeof window !== 'undefined') {
    const level = localStorage.getItem('OPENCLAW_LOG_LEVEL') as LogLevel;
...
export function setLogLevel(level: LogLevel): void {
  localStorage.setItem('OPENCLAW_LOG_LEVEL', level);
...
export const agentsLogger = createLogger('Agents');
