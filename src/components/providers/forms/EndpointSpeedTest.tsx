    ...
    >
      <div className="glass rounded-xl p-6 border border-white/10 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
              <input
                ...
                className="h-3.5 w-3.5 rounded border-border-subtle bg-background text-primary focus:ring-2 focus:ring-primary/20"
              />
        ...
        {hasEndpoints ? (
          ...
          <div className="rounded-md border border-dashed border-border-subtle bg-muted px-4 py-8 text-center text-sm text-text-muted">
