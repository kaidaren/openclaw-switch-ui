...
mod tests {
    ...
    fn build_remote_url_encodes_path_segments() {
        ...
        assert_eq!(
            url,
            "https://dav.example.com/remote.php/dav/files/demo/claw%20switch-sync/v2/default%20profile/manifest.json"
        );
        assert!(!url.contains("//claw"), "should not have double-slash");
    }
