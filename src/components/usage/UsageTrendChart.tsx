...
export function UsageTrendChart({
  ...
  if (isLoading) {
    return (
      <div className="flex h-[350px] items-center justify-center rounded-xl bg-card/40 border border-border-subtle">
  ...
  return (
    <div className="rounded-xl border border-border-subtle bg-card/40 p-6 backdrop-blur-sm">
