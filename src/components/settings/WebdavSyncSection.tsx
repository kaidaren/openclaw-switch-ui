...
export function WebdavSyncSection({ config }: WebdavSyncSectionProps) {
  ...
  const [form, setForm] = useState(() => ({
    ...
    remoteRoot: config?.remoteRoot ?? "claw-switch-sync",
  ...
  const buildSettings = useCallback((): WebDavSyncSettings | null => {
    ...
    return {
      ...
      remoteRoot: form.remoteRoot.trim() || "claw-switch-sync",
    ...
    <section className="space-y-4">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-muted/40 p-6">
        ...
        <div className="space-y-3">
          ...
          {/* Preset hint */}
          {activePreset?.hint && (
            <div className="flex items-start gap-2 pl-44 text-xs text-text-muted">
              ...
              <div className="space-y-3 text-sm leading-relaxed">
                ...
                <p className="text-text-muted">
                  ...
                  <code className="ml-1 text-xs bg-muted px-1.5 py-0.5 rounded">
                    /{form.remoteRoot.trim() || "claw-switch-sync"}/v2/
                ...
                {remoteInfo && (
                  <div className="rounded-lg border border-border bg-muted/50 p-3 space-y-2">
                    ...
                    <dl className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1.5 text-xs text-text-muted">
        ...
        <DialogContent className="max-w-sm" zIndex="alert">
          <DialogHeader className="space-y-3 border-b-0 bg-transparent pb-0">
            ...
            <DialogDescription asChild>
              <div className="space-y-3 text-sm leading-relaxed">
                {remoteInfo && (
                  <dl className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1.5 text-text-muted">
                    <dt className="font-medium text-foreground">
