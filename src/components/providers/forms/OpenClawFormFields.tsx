    ...
    <>
      ...
      <div className="rounded-lg border border-border bg-muted/20 p-4 space-y-3">
        ...
        <TestConnectionButton
          ...
          baseUrl={baseUrl}
          apiKey={apiKey}
          modelName={models[0]?.id || undefined}
          unsupportedHint={t("openclaw.testConnection.unsupportedHint", {
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="h-9 w-9 mt-5 text-text-muted hover:text-destructive"
                  >
                ...
                >
                  <CollapsibleTrigger asChild>
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="h-7 gap-1 text-xs text-text-muted hover:text-foreground"
                    >
