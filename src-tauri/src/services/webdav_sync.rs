...
const PROTOCOL_FORMAT: &str = "claw-switch-webdav-sync";
...
fn detect_system_device_name() -> Option<String> {
    let env_name = ["claw_switch_DEVICE_NAME", "COMPUTERNAME", "HOSTNAME"]
        .iter()
...
mod tests {
    ...
    fn remote_dir_segments_uses_v2() {
        ...
        assert_eq!(segs, vec!["claw-switch-sync", "v2", "default"]);
    }
